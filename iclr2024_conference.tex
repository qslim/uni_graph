...
% \title{A Unified View on the Representational Power of Graph Convolution, Message-passing NNs and Graph Transformers from the Spectral Perspective}
...
\begin{document}
	...
	\begin{proof}
		% We use the variable $\rmY^*\in\sR^{n\times c}$ to denote all node labels with the domain being all possible assignments of node labels.
		% With proper approximator $\vt^{(i)}$/There always exists proper approximator $\vt^{(i)}$ such that,
		...
		%    \begin{equation}
			%        \begin{aligned}
				%            \left\|\vy^*_i-\rmM^{(i)}\vh_i\right\|^2_2&=\left\|\rmU^{(i)}\rmU^{(i)\top}\vy^*_i-\rmU^{(i)}\mathrm{diag}\left(\vt^{(i)}\right)\rmU^{(i)\top}\vh_i\right\|_2^2\\
				%            &\leq\left\|\rmU^{(i)}\right\|_F^2\left\|\rmU^{(i)\top}\vy^*_i-\mathrm{diag}\left(\vt^{(i)}\right)\rmU^{(i)\top}\vh_i\right\|_2^2\\
				%            &=n\left\|\rmU^{(i)\top}\vy^*_i-\mathrm{diag}\left(\rmU^{(i)\top}\vh_i\right)\vt^{(i)}\right\|_2^2\\
				%            &=n\left\|\mathrm{diag}\left(\rmU^{(i)\top}\vh_i\right)\left(\mathrm{diag}^{-1}\left(\rmU^{(i)\top}\vh_i\right)\rmU^{(i)\top}\vy^*_i-\vt^{(i)}\right)\right\|_2^2\\
				%            &\leq n\left\|\rmU^{(i)\top}\vh_i\right\|_2^2\left\|\mathrm{diag}^{-1}\left(\rmU^{(i)\top}\vh_i\right)\rmU^{(i)\top}\vy^*_i-\vt^{(i)}\right\|_2^2\\
				%            &\leq n\left\|\rmU^{(i)\top}\right\|_F^2\left\|\vh_i\right\|_2^2\left\|\mathrm{diag}^{-1}\left(\rmU^{(i)\top}\vh_i\right)\rmU^{(i)\top}\vy^*_i-\vt^{(i)}\right\|_2^2\\
				%            &\leq n^2\eta^2\left\|\mathrm{diag}^{-1}\left(\rmU^{(i)\top}\vh_i\right)\rmU^{(i)\top}\vy^*_i-\vt^{(i)}\right\|_2^2\\
				%            &=n^2\eta^2\underbrace{\left\|\left[\frac{\vu_j^{(i)\top}\vy^*_i}{\vu_j^{(i)\top}\vh_i}\right]^{(j)\top}-\vt^{(i)}\right\|_2^2}_{\leq\epsilon^2}\\
	...
	%    \begin{equation}
		%        \begin{aligned}
			%            \|\rmY^{\textrm{train}}-\rmT\rmM\rmH\|_F&=\left\|\rmT\left(\rmY^*-\rmM\rmH\right)\right\|_F\\
			...
			%            &=\sqrt{m}\sqrt{n}\sqrt{\sum_{i=1}^c\left\|\rmU^{\top}\vy^*_i-\mathrm{diag}\left(\vt\right)\rmU^{\top}\vh_i\right\|^2_2}\\
			%            &\leq\sqrt{m}\sqrt{n}\sum_{i=1}^c\left\|\rmU^{\top}\vy^*_i-\mathrm{diag}\left(\vt\right)\rmU^{\top}\vh_i\right\|_2\\
			%            &=\sqrt{m}\sqrt{n}\sum_{i=1}^c\left\|\rmU^{\top}\vy^*_i-\mathrm{diag}\left(\rmU^{\top}\vh_i\right)\vt\right\|_2\\
			%            &=\sqrt{m}\sqrt{n}\sum_{i=1}^c\left\|\mathrm{diag}\left(\rmU^{\top}\vh_i\right)\left(\mathrm{diag}^{-1}\left(\rmU^{\top}\vh_i\right)\rmU^{\top}\vy^*_i-\vt\right)\right\|_2\\
			%            &\leq\sqrt{m}\sqrt{n}\sum_{i=1}^c\left\|\rmU^{\top}\vh_i\right\|_2\left\|\mathrm{diag}^{-1}\left(\rmU^{\top}\vh_i\right)\rmU^{\top}\vy^*_i-\vt\right\|_2\\
			%            &\leq\sqrt{m}\sqrt{n}\sum_{i=1}^c\left\|\rmU^{\top}\right\|_F\left\|\vh_i\right\|_2\left\|\mathrm{diag}^{-1}\left(\rmU^{\top}\vh_i\right)\rmU^{\top}\vy^*_i-\vt\right\|_2\\
			%            &=\sqrt{m}n\sum_{i=1}^c\left\|\vh_i\right\|_2\left\|\mathrm{diag}^{-1}\left(\rmU^{\top}\vh_i\right)\rmU^{\top}\vy^*_i-\vt\right\|_2\\
			%            &\leq\sqrt{m}n\eta\sum_{i=1}^c\left\|\mathrm{diag}^{-1}\left(\rmU^{\top}\vh_i\right)\rmU^{\top}\vy^*_i-\vt\right\|_2\\
			%            &=\sqrt{m}n\eta\sum_{i=1}^c\underbrace{\left\|\mathrm{vec}_j\left(\frac{\vu_j^{\top}\vy^*_i}{\vu_j^{\top}\vh_i}\right)-\vt\right\|_2}_{\leq\epsilon}\\
			%            % &=\sqrt{m}n\eta\sum_{i=1}^c\left\|\mathrm{vec}_j\left(\frac{\vu_j^{\top}[\vy^{\textrm{train}}_i\|\vy^*_i]}{\vu_j^{\top}\vh_i}\right)-\vt\right\|_2\\
			%            &\leq\sqrt{m}cn\eta\epsilon
			% \end{aligned}
		%    \end{equation}
	
	%    \begin{equation}
		%        \begin{aligned}
			%            \left\|\rmY^{\textrm{train}}-\rmT\left[\rmM^{(i)}\vh_i\right]^{(c)}\right\|_F&=\left\|\rmT\left(\rmY^*-\left[\rmM^{(i)}\vh_i\right]^{(c)}\right)\right\|_F\\
			%            &\leq\left\|\rmT\right\|_F\left\|\rmY^*-\left[\rmM^{(i)}\vh_i\right]^{(c)}\right\|_F\\
			%            &=\sqrt{m}\left\|\left[\vy^*_i\right]^{(c)}-\left[\rmM^{(i)}\vh_i\right]^{(c)}\right\|_F\\
			%            &=\sqrt{m}\sqrt{\sum_{i=1}^c\left\|\vy^*_i-\rmM^{(i)}\vh_i\right\|^2_2}\\
			%            &\leq\sqrt{m}\sum_{i=1}^c\left\|\vy^*_i-\rmM^{(i)}\vh_i\right\|_2\\
			%            &=\sqrt{m}\sum_{i=1}^c\left\|\rmU^{(i)}\rmU^{(i)\top}\vy^*_i-\rmU^{(i)}\mathrm{diag}\left(\vt^{(i)}\right)\rmU^{(i)\top}\vh_i\right\|_2\\
			%            &\leq\sqrt{m}\sum_{i=1}^c\left\|\rmU^{(i)}\right\|_F\left\|\rmU^{(i)\top}\vy^*_i-\mathrm{diag}\left(\vt^{(i)}\right)\rmU^{(i)\top}\vh_i\right\|_2\\
			%            &=\sqrt{m}\sqrt{n}\sum_{i=1}^c\left\|\rmU^{(i)\top}\vy^*_i-\mathrm{diag}\left(\vt^{(i)}\right)\rmU^{(i)\top}\vh_i\right\|_2\\
			%            &=\sqrt{m}\sqrt{n}\sum_{i=1}^c\left\|\rmU^{(i)\top}\vy^*_i-\mathrm{diag}\left(\rmU^{(i)\top}\vh_i\right)\vt^{(i)}\right\|_2\\
			%            &=\sqrt{m}\sqrt{n}\sum_{i=1}^c\left\|\mathrm{diag}\left(\rmU^{(i)\top}\vh_i\right)\left(\mathrm{diag}^{-1}\left(\rmU^{(i)\top}\vh_i\right)\rmU^{(i)\top}\vy^*_i-\vt^{(i)}\right)\right\|_2\\
			%            &\leq\sqrt{m}\sqrt{n}\sum_{i=1}^c\left\|\rmU^{(i)\top}\vh_i\right\|_2\left\|\mathrm{diag}^{-1}\left(\rmU^{(i)\top}\vh_i\right)\rmU^{(i)\top}\vy^*_i-\vt^{(i)}\right\|_2\\
			%            &\leq\sqrt{m}\sqrt{n}\sum_{i=1}^c\left\|\rmU^{(i)\top}\right\|_F\left\|\vh_i\right\|_2\left\|\mathrm{diag}^{-1}\left(\rmU^{(i)\top}\vh_i\right)\rmU^{(i)\top}\vy^*_i-\vt^{(i)}\right\|_2\\
			%            &=\sqrt{m}n\sum_{i=1}^c\left\|\vh_i\right\|_2\left\|\mathrm{diag}^{-1}\left(\rmU^{(i)\top}\vh_i\right)\rmU^{(i)\top}\vy^*_i-\vt^{(i)}\right\|_2\\
			%            &\leq\sqrt{m}n\eta\sum_{i=1}^c\left\|\mathrm{diag}^{-1}\left(\rmU^{(i)\top}\vh_i\right)\rmU^{(i)\top}\vy^*_i-\vt^{(i)}\right\|_2\\
			%            &=\sqrt{m}n\eta\sum_{i=1}^c\underbrace{\left\|\left[\frac{\vu_j^{(i)\top}\vy^*_i}{\vu_j^{(i)\top}\vh_i}\right]^{(j)\top}-\vt^{(i)}\right\|_2}_{\leq\epsilon}\\
			%            &\leq\sqrt{m}cn\eta\epsilon
			% \end{aligned}
		%    \end{equation}
	%    Therefore, we have:
	%    \begin{equation}
		%        \begin{aligned}
			%            \gL&=\left\|\rmY^{\textrm{train}}-\rmT\left[\rmM^{(i)}\vh_i\right]^{(c)}\right\|^2_F\\
			%            &\leq m(cn\eta\epsilon)^2
			% \end{aligned}
		%    \end{equation}
